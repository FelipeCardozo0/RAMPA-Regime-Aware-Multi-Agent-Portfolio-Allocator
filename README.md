...
![Asset Price History](docs/figures/figure_01_price_series.png)  
...
![Return Correlation Matrix](docs/figures/figure_02_return_statistics.png)  
...
![Return Distributions](docs/figures/figure_03_return_estimators.png)  
...
![PCA Explained Variance](docs/figures/figure_04_covariance_comparison.png)  
...
![Factor Loadings](docs/figures/figure_05_covariance_diagnostics.png)  
...
![Fractional Differentiation](docs/figures/figure_06_efficient_frontier.png)  
...
![Regime Timeline](docs/figures2/image_03_hmm_regime_detection.png)  
...
![Regime Posteriors](docs/figures/figure_07_optimal_weights.png)  
...
![Transition Matrix](docs/figures/figure_08_risk_parity.png)  
...
![Return Stats by Regime](docs/figures/figure_09_cvar_optimization.png)  
...
![SVM Confusion Matrices](docs/figures2/table_07_model_validation.png)  
...
![Feature Importance](docs/figures2/image_06_feature_importance_ic.png)  
...
![Rolling IC](docs/figures/figure_12_rolling_metrics.png)  
...
![Alpha Signal Heatmap](docs/figures/figure_13_attribution.png)  
...
![GARCH Volatility](docs/figures/figure_15_sensitivity.png)  
...
![IV Surface](docs/figures2/image_04_volatility_surface.png)  
...
![DNN Calibration](docs/figures/figure_14_risk_dashboard.png)  
...
![Hurst Over Time](docs/figures2/image_02_asset_universe.png)  
...
![Training Reward Curve](docs/figures2/image_05_rl_training.png)  
...
![Weight Allocation](docs/figures2/image_07_regime_weights.png)  
...
![Weights by Regime](docs/figures2/image_07_regime_weights.png)  
...
![Cumulative Returns](docs/figures/figure_10_cumulative_returns.png)  
...
![Drawdown](docs/figures/figure_11_drawdown.png)  
...
![Rolling Sharpe](docs/figures/figure_12_rolling_metrics.png)  
...
![Metrics Comparison](docs/figures2/table_05_strategy_comparison.png)  
...
![Monthly Returns Heatmap](docs/figures2/image_08_backtest_performance.png)  
